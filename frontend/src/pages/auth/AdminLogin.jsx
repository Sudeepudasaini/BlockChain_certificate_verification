...
export default function AdminLogin() {
  const [email, setEmail] = useState('admin@certchain.edu')
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ background: '#0b1220' }}>
      <div className="w-full max-w-md p-8 rounded-xl shadow-lg" style={{ background: '#0f1b2b', border: '1px solid rgba(255,255,255,0.03)' }}>
        <div className="flex flex-col items-center mb-6">
          <div className="w-16 h-16 rounded-full flex items-center justify-center" style={{ background: 'rgba(255,255,255,0.03)' }}>
          ...
          <p className="text-gray-300 text-sm mt-1">System Administration Panel</p>
        </div>

        <div className="mb-6 p-4 rounded-md" style={{ background: '#102232', border: '1px solid #59491f' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input
            ...
            className="w-full mb-4 px-4 py-3 rounded-md bg-[#0b1622] text-gray-200 border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500"
          ...
          <div className="relative mb-6">
            <input
              ...
              className="w-full px-4 py-3 rounded-md bg-[#0b1622] text-gray-200 border border-transparent focus:outline-none focus:ring-2 focus:ring-indigo-500"
              placeholder="●●●●●●●●"
              required
            />
            <button
